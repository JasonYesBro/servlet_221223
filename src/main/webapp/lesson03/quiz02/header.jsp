...
<div class="logo mx-3">
	...
	<div class="search d-flex flex-row input-group w-75">
		<form action="/lesson03/quiz02/info_layout.jsp" method="get" class="d-flex flex-row w-100">
			<input type="text" name="title" class="search form-control" placeholder="곡 제목을 입력하세요."
